...
Much of my time is spent homelabbing/self-hosting, shown in the **Sapphic Homelab/Home Server**, a cluster of repurposed machines running Proxmox and TrueNAS SCALE. They host many NixOS/Linux-based virtual machines and Docker-based containers (with Docker Compose and Komodo), supported with CI/CD pipelines and automation scripts. Services hosted include *Home Assistant*, *Pterodactyl* (for game hosting), and *a Linux-based development server*, all connected together with Traefik and Tailscale. For a video demonstration, [watch here.](https://www.youtube.com/watch?v=hI5Pl6_dHzY)
